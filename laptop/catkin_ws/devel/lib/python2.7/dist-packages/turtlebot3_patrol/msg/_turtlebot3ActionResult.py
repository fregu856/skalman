...
"""autogenerated by genpy from turtlebot3_patrol/turtlebot3ActionResult.msg. Do not edit."""
import sys
...
class turtlebot3ActionResult(genpy.Message):
  ...
  _type = "turtlebot3_patrol/turtlebot3ActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot3_patrol/turtlebot3Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = turtlebot3_patrol.msg.turtlebot3Result()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = turtlebot3_patrol.msg.turtlebot3Result()
